"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_vue_views_create-appointment_end-request_end-request_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/vue/views/create-appointment/end-request/end-request.vue?vue&type=script&lang=js":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/vue/views/create-appointment/end-request/end-request.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************************************/
...
/* harmony export */ });
/* harmony import */ var _fullcalendar_vue3__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fullcalendar/vue3 */ "./node_modules/@fullcalendar/vue3/dist/index.js");
...
/* harmony import */ var _components_shared_ButtonApp_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../components/shared/ButtonApp.vue */ "./resources/js/vue/components/shared/ButtonApp.vue");
...
/* harmony import */ var _core_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../core/utils */ "./resources/js/vue/core/utils.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    FullCalendar: _fullcalendar_vue3__WEBPACK_IMPORTED_MODULE_4__["default"],
    ButtonApp: _components_shared_ButtonApp_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  mixins: [],
  props: {},
  data: function data() {
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapActions)(['FETCH_ENROLMENTS_POINTS', "FORM_DATA_REQUEST", 'FETCH_FERRY_DAY', 'SAVE_APPOINTMENT'])), (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapGetters)({
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      var url = "api/get-one-appointment-by-id/" + ((_this$formDataRequest = this.formDataRequest) === null || _this$formDataRequest === void 0 || (_this$formDataRequest = _this$formDataRequest.user) === null || _this$formDataRequest === void 0 ? void 0 : _this$formDataRequest.siteAppointmentId);
      if (today) {
    ...
    fetchHolidays: function fetchHolidays(startDate, endDate) {
      var _this2 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('api/get-ferry-current-day', {
                params: {
                  start: startDate,
                  end: endDate
                }
            ...
            case 3:
              ...
              _this2.holidays = response.data.map(function (event) {
              ...
              console.log("Holidays dates:", _this2.holidays);
              _context.next = 12;
              break;
            case 9:
              _context.prev = 9;
    ...
    handleDatesSet: function handleDatesSet(fetchInfo) {
      var _this3 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _this3.addHoverEffectToColumns();
              startDate = fetchInfo.startStr.split('T')[0];
              endDate = fetchInfo.endStr.split('T')[0];
              _this3.currentStartDate = startDate;
              _this3.currentEndDate = endDate;
              _context2.next = 7;
              return _this3.fetchHolidays(startDate, endDate);
            case 7:
              // Rafraîchissez les événements
              _this3.calendarOptions.events = _this3.holidays.map(function (event) {
                return {
                  start: event.start,
                  title: event.title,
                  display: 'background',
    ...
    addHoverEffectToColumns: function addHoverEffectToColumns() {
      var _this4 = this;
      this.$nextTick(function () {
        var calendarEl = _this4.$refs.fullCalendar.$el;
        ...
        dayCells.forEach(function (cell) {
          ...
          if (day !== 0 && day !== 6) {
            ...
            frame.addEventListener('mouseenter', _this4.handleMouseEnter);
            frame.addEventListener('mouseleave', _this4.handleMouseLeave);
            frame.addEventListener('click', _this4.handleCellClick);
          }
        });
      });
    },
    ...
    handleCellClick: function handleCellClick(event) {
      var date = event.currentTarget.closest('.fc-daygrid-day').getAttribute('data-date');
      var day = new Date(date).getDay();
      if (day === 0 || day === 6) {
        return;
      }
      ...
      if (this.selectedCell) {
        ...
        var _checkbox = this.selectedCell.querySelector('input[type="checkbox"]');
        if (_checkbox) {
          this.selectedCell.removeChild(_checkbox);
        }
      }
    ...
    // },
    handleDayCellDidMount: function handleDayCellDidMount(args) {
      var day = new Date(args.date).getDay();
      var cellContent = args.el.querySelector('.fc-daygrid-day-frame');
      var cellText = document.createElement('div');
      cellText.className = 'cell-text';
      var formattedDate = new Date(args.date).toISOString().split('T')[0];

      // Obtenir la date actuelle en timestamp
      var today = new Date();
      today.setHours(0, 0, 0, 0); // Réinitialiser les heures, minutes, secondes et millisecondes
      var todayTimestamp = today.getTime(); // Timestamp pour aujourd'hui

      // Extraire et formater la date de la cellule
      var cellDateStr = args.date;
      var cellDate = new Date(cellDateStr);
      cellDate.setHours(0, 0, 0, 0); // Réinitialiser les heures, minutes, secondes et millisecondes
      var cellDateTimestamp = cellDate.getTime(); // Timestamp pour la date de la cellule
    ...
    handleEventDidMount: function handleEventDidMount(args) {
      var eventDate = args.event.startStr;
      var cell = this.$refs.fullCalendar.$el.querySelector("[data-date=\"".concat(eventDate, "\"]"));
      if (cell) {
        // Vider le contenu actuel de la cellule
        var cellContent = cell.querySelector('.fc-daygrid-day-frame');
        if (cellContent) {
    ...
    onDateChange: function onDateChange(data) {
      var payload = {
        ...
        data: _this5.dateAppointment
      };
      _this5.$store.dispatch('FORM_DATA_REQUEST', payload);
    },
    hasFerry: function hasFerry(data) {
      return this.ferry_days.find(function (date) {
        return new Date(data.day).getTime() == new Date(date.date_jfpe).getTime();
      }) != undefined;
    },
    onReturn: function onReturn() {
      var _this$formDataRequest3;
      this.$router.push({
        name: "appointment-start",
        params: {
          documentId: (_this$formDataRequest3 = this.formDataRequest) === null || _this$formDataRequest3 === void 0 || (_this$formDataRequest3 = _this$formDataRequest3.user) === null || _this$formDataRequest3 === void 0 ? void 0 : _this$formDataRequest3.documentId
        }
      });
    },
    ...
    onSaveAppointment: function () {
      var _onSaveAppointment = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var _this$formDataRequest4,
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 6:
              ...
              formData.append("date_rdv_demande", (0,date_fns__WEBPACK_IMPORTED_MODULE_9__.format)(new Date(this.date_rdv_demande), "yyyy-MM-dd"));
              formData.append("numero_recu", (_this$formDataRequest4 = this.formDataRequest) === null || _this$formDataRequest4 === void 0 || (_this$formDataRequest4 = _this$formDataRequest4.user) === null || _this$formDataRequest4 === void 0 ? void 0 : _this$formDataRequest4.numero_recu);
              ...
              formData.append("id_demande", (_this$formDataRequest5 = this.formDataRequest) === null || _this$formDataRequest5 === void 0 || (_this$formDataRequest5 = _this$formDataRequest5.user) === null || _this$formDataRequest5 === void 0 ? void 0 : _this$formDataRequest5.documentId);
              formData.append("type_service_passport", null);
              formData.append("id_type_service", (_this$formDataRequest6 = (_this$formDataRequest7 = this.formDataRequest) === null || _this$formDataRequest7 === void 0 || (_this$formDataRequest7 = _this$formDataRequest7.user) === null || _this$formDataRequest7 === void 0 ? void 0 : _this$formDataRequest7.serviceId.id) !== null && _this$formDataRequest6 !== void 0 ? _this$formDataRequest6 : null);
              formData.append("id_point_enrolement", (_this$formDataRequest8 = this.formDataRequest) === null || _this$formDataRequest8 === void 0 || (_this$formDataRequest8 = _this$formDataRequest8.user) === null || _this$formDataRequest8 === void 0 ? void 0 : _this$formDataRequest8.siteAppointmentId);

              // await this.$store.dispatch("SAVE_APPOINTMENT", formData)
              axios__WEBPACK_IMPORTED_MODULE_8__["default"].post("/api/save-appointment", formData).then(function (responseAxios) {
                _this6.isLoadingSaveAppointment = false;
                ...
                if (responseAxios.data.status == 200) {
                  ...
                  _this6.$swal({
                    position: "center",
                    icon: "success",
                    title: (_responseAxios$data$m2 = (_responseAxios$data2 = responseAxios.data) === null || _responseAxios$data2 === void 0 ? void 0 : _responseAxios$data2.message) !== null && _responseAxios$data$m2 !== void 0 ? _responseAxios$data$m2 : "Demande enregistré",
      ...
      function onSaveAppointment() {
        return _onSaveAppointment.apply(this, arguments);
      }
      return onSaveAppointment;
    }(),
    numberDay: function numberDay(data) {
      var _data$day;
      return data === null || data === void 0 || (_data$day = data.day) === null || _data$day === void 0 ? void 0 : _data$day.split('-').slice(1).join('-').split('-').slice(1).join();
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/vue/views/create-appointment/end-request/end-request.vue?vue&type=template&id=c5606edc":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/vue/views/create-appointment/end-request/end-request.vue?vue&type=template&id=c5606edc ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _hoisted_3 = {
  "class": "col-12 col-md-10 order-1 order-md-0"
};
var _hoisted_4 = {
  "class": "col-12 col-md-2 order-0 order-md-1"
};
var _hoisted_5 = {
...
var _hoisted_8 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"col-sm-12 col-md-12 mb-1\" style=\"margin-top:1.5rem;\"><b>Horaire</b></div><div class=\"col-sm-12 col-md-12 d-flex\"><div class=\"item-time text-center w-100 rounded-2 w-auto\"><span class=\"\">Matin 8h30-12h30</span></div><div class=\"col-sm-12 col-md-6 col-lg-6 w-auto mr-1 ml-1\"> / </div><div class=\"item-time text-center w-100 rounded-2 w-auto\"><span class=\"\">Soir 13h30-17h00</span></div></div>", 2);
var _hoisted_10 = {
  "class": "col-12"
};
var _hoisted_11 = {
...
var _hoisted_12 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("b", null, "Point d'enrolement", -1 /* HOISTED */);
var _hoisted_13 = {
  "class": "text-info"
};
var _hoisted_14 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_FullCalendar, {
    options: $data.calendarOptions,
    ref: "fullCalendar",
    "class": "calendar-container"
  }, null, 8 /* PROPS */, ["options"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [_hoisted_6, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_el_tag, {
    "class": "",
    style: {
      "width": "auto",
      "margin-right": "10px"
    ...
    "button-title": "Retour",
    "class": "space1",
    onClick: $options.onReturn
  }, null, 8 /* PROPS */, ["onClick"]), [[_directive_loading, _ctx.isLoading]]), $data.disabledSave ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_el_button, {
    key: 0,
    type: "primary",
    "class": "space buttonE",
    disabled: "true"
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Valider ")];
    }),
    _: 1 /* STABLE */
  })) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_ButtonApp, {
    key: 1,
    "button-title": "Valider",
    "class": "space",
    onClick: $options.onSaveAppointment
  }, null, 8 /* PROPS */, ["onClick"])), [[_directive_loading, $data.isLoadingSaveAppointment]])])])])]);
}

/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js