...
*/
            ...
            @if (auth()->user()->id_role)
                ...
                @if (auth()->user()->id_role == 4)
                    @kcan('gestion-pre-demande')
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('pre-demande') && empty(request()->query()) ? 'text-danger' : '' }}"
                                href="{{ route('pre.demande') }}">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>OMNIFORM</span></strong>. All Rights Reserved
        </div>
