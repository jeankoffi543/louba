                    ...
                    <form method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-header">
                                <h4 style="font-weight:bold; text-transform:uppercase">Enregistrer un slide </h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">Description complète</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputNumber" class="col-sm-2 col-form-label"> Image arriere
                                            plan</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="file" name="imagebg" required>
                                        </div>
                                    </div>
                                </div>
