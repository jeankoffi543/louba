            ...
            <div id="contain">
                ...
                @foreach( $equipes as $equipe  )
                    ...
                    <div class="four columns item">
                        <img src="images/img/team/member-1.jpg" alt="">
                        <p><h4>{{$equipe->nom_prenom}}</h4> </p>
                        <br><br>
                        <div class="clearfix"></div>
                        <span style="color:green;text-transform:uppercase"> {{$equipe->poste}}</span><br>
                        {{$equipe->description}}
                        </p>
                        <div class="member-social">
                            <a href="#"><i class="social_icon-twitter s-17"></i></a>
                            ...
                            <a href="#"><i class="social_icon-linkedin s-17"></i></a>
                        </div>
                    </div>
                    <!-- End -->
