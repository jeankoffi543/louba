        ...
        <div class="container clearfix" style="text-align:center">
            ...
            <form method="POST" action="/suivreMesDocuments">
                ...
                <div class="waviy" style="color:black">
                    <h3 style="display:inline;color:#ffc107;font-weight:normal">Verifier le statut de votre
                        Document</h3>
                ...
                <ul class="slider" id="sliderName4" style="text-align:center">
                    ...
                    <li class="slide">
                        <div class="four columns item"
                             style="height:100px;text-align:center;margin-left:0px;margin-right:0px;"><a href="#"><img
                                    class="partenair" src="imgg/p0.jpg" alt=""/></a></div>
                        <div class="four columns item"
                             style="height:100px;text-align:center;margin-left:0px;margin-right:0px;"><a href="#"><img
                                    class="partenair" src="imgg/p1.jpg" alt=""/></a></div>
                        <div class="four columns item"
                             style="height:100px;text-align:center;margin-left:0px;margin-right:0px;"><a href="#"><img
                                    class="partenair" src="imgg/p2.jpg" alt=""/></a></div>
                        <div class="four columns item"
                             style="height:100px;text-align:center;margin-left:0px;margin-right:0px;"><a href="#"><img
                                    class="partenair" src="imgg/p3.jpg" alt=""/></a></div>
                        <div class="four columns item"
                             style="height:100px;text-align:center;margin-left:0px;margin-right:0px;"><a href="#"><img
                                    class="partenair" src="imgg/p5.jpg" alt=""/></a></div>
                        <div class="four columns item"
                             style="height:100px;text-align:center;margin-left:0px;margin-right:0px;"><a href="#"><img
                                    class="partenair" src="imgg/p4.jpg" alt=""/></a></div>
                        <div class="four columns item"
                             style="height:100px;text-align:center;margin-left:0px;margin-right:0px;"><a href="#"><img
                                    class="partenair" src="imgg/p8.jpg" alt=""/></a></div>
